      ...
      <div className="relative z-10 w-full max-w-[360px] sm:max-w-[400px] animate-fade-up">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 shadow-2xl rounded-2xl p-6 sm:p-10">
          ...
          <form className="space-y-3.5 sm:space-y-5" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-gray-600 mb-1 sm:mb-1.5">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-gray-600 mb-1 sm:mb-1.5">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
